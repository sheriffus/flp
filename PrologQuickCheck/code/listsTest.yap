...
{listsTest:dl2l, 1}
    ...
    % {{{ dl2l 2
{listsTest:dl2l, 2}
    of_type (L-(listsTest:difListOf(int)), DL-(plqc:variable))
    ...
    % {{{ dl2l 3
{listsTest:dl2l, 3}
    of_type (DL-(listsTest:difListOf(int)), L-(plqc:variable))
    where (i(ngv, v), o(ngv, g))
    %% where (i(ngv, v), o(g, g), o(ngv, g))
    has_range {1,1} % default 1-inf
    pre_cond (var(L), 1\=2)
...
{listsTest:test, 1} of_type (plqc:listOf(int), plqc:variable).
{listsTest:test, 2} of_type (L-(plqc:listOf(int)), plqc:variable) such_that listsTest:odd_arg1.
{listsTest:test, 3} of_type (L-(plqc:listOf(int)), plqc:variable) such_that listsTest:odd_arg1 post_cond (L \= []).
{listsTest:test, 4} of_type (L-(plqc:listOf(int)), plqc:variable) such_that listsTest:odd_arg1 has_range {1,1} post_cond (L \= []).

{listsTest:test, 5}
    of_type (L-(plqc:listOf(int)), plqc:variable)
    such_that listsTest:odd_arg1
