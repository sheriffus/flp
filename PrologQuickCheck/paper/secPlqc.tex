...
\yap{m}, and will have access to the \plqc{} tool module.
%
...
property over random lists of integers \yap{XS}.
%
More precisely, we use \yap{qcforall/3}, \plqc{}'s universal quantification.
%
...
\yap{m:qcprop(double_rev)} to define the property.
\begin{yapcode}
...
\begin{yapcode}
 ...
 Counterexample found: [[3,0,1,0]]  % TODO: fix this output
\end{yapcode}
...
Available operators currently include conjunction (\yap{Prop1 qcand Prop2}), disjunction (\yap{Prop1 qcor Prop2}),
conditional execution (\yap{qcif(Cond, Porp1, Prop2)}) and quantification (\yap{qcforall(Gen, Var, Prop)}).
%
%% \begin{yapcode}
%%    Prop1 qcand Prop2
%%    Prop1 qcor Prop2
...
%
Property labelling (\yap{qcprop(Label)}) is also considered an operation.
%
