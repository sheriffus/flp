...
One can test a property, or \emph{quickcheck} it,  by passing it as a parameter in a
call to a predicate of the \plqc{} testing interface: \yap{quickcheck/[1,2]},
...
%% %
%% \begin{yapcode}
%%  run(pcforall(Gen, Var, Test, Size),
...
%%    Prop = pcforall(ArgGen, Args, InnerProp).
%% \end{yapcode}
