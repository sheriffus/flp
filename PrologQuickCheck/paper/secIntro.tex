...
%
The approach used
can be  manual, with the tester %% developer
designing test cases one by \todo{test developer -> tester (vsc?)}
one, or it can be automated to some extent, in this case resorting to
tools for case generation. \todo{havia uma nota aqui ([]) que eu não percebo}
%
...
%% In this work w
We introduce \plqc{}\footnote{The \plqc{} tool is available at \url{www.dcc.fc.up.pt/~coa/PrologCheck.html}.},
...
\Prolog{} goals, which \plqc{} checks for a number of inputs. \todo{mais
um comentario que nao percebo}
%
...
a boolean type, to determine primitive properties. \todo{em vez de
...
%% properties, i
In \plqc{} primitive properties are %% defined as
\Prolog{} goals and can be composed by \plqc{} operations.%% a property is a goal or a composition of
%% properties.
