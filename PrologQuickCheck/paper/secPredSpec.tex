...
%
They are mandatory in order to guarantee that the specification may be
...
the set of terms represented by a generator.
%
...
%
It states nothing about other kinds of parameters.
%
